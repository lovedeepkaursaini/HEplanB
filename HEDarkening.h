...
class HEDarkening {
 ...
 // static const unsigned int Nlayer = 18;
  ...
  float ilumi[14];//=   {5.6, 28.9,33.0,63.0,128.0,193.0,293.0,393.0,493.0};
  float lumi[14];//={5.6, 23.3,4.1, 30,  65,  65,  100, 100, 100};
  float doserate[14];//={0.005,0.013,0.009,0.026,0.043,0.043,0.05,0.05,0.05};
};
#endif // HEDarkening_h
